locals {
  ...
  # 镜像版本：Trino分布式SQL查询工具-cn
  #Trino分布式SQL查询工具hce
  instance_image_id_maps_v1 = {
#     北京4
    cn-north-4     = "2a22212c-3333-4b71-94d7-b593004dedff"
#     广州
    cn-south-1     = "734e746e-d333-442d-baf2-cfe38ae42045"
#     上海一
    cn-east-3      = "88e4984c-b6cd-4198-80ae-b958e6df2b38"
#     乌兰察布一
    cn-north-9     = "3ead618b-a535-43ab-9d56-f4807d2bf650"
#     贵阳一
    cn-southwest-2 = "3d12ccf9-ccf7-423e-847a-0ecf80122b40"
