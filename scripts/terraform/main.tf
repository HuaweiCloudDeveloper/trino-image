...
module "ecs" {
  ...
  instance_image_id  = var.Version == "Trino475-arm-v1.0" ? local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region] : local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region]
