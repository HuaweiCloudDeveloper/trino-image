...
**Trino** 是一个快速的分布式 SQL 查询引擎，主要用于大数据分析。
...
## 通过ip+8080登录UI界面
username可以随便输入，然后点击登录
![img.png](images/img_4.png)
![img_1.png](images/img_5.png)

## 使用Shell连接，进入 Trino CLI
```bash
docker exec -it trino trino --server localhost:8080 --catalog system --schema runtime
```
