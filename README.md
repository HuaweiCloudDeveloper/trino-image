...
[Trino](https://github.com/trinodb/trino) is a fast distributed SQL query engine primarily used for big data analysis.

**Core Features:**
- **Distributed Architecture:** TrinoDB adopts a distributed architecture, which can fully utilize the computing resources in the cluster to achieve efficient parallel query processing.
- **Multi - Data Source Support:** It supports connecting to various data sources, including big data storage systems and relational databases, providing a unified data access interface.
- **High - Performance Query:** Through an optimized query plan and execution engine, it achieves fast data analysis and query response.
